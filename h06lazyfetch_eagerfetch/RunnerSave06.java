...
2)To convert Lazy Fetch to Eager Fetch you shoul type "fetch=FetchType.EAGER" into @OneToMany() or
 @ManyToOne()
3)If you type "fetch=FetchType.EAGER" into @OneToMany() all fetches will behave like Eager Fetch
 If you type "fetch=FetchType.EAGER" into @ManyToOne() fetches from child class will behave like
 Eager Fetch,fetches from parent class will behave like Lazy Fetch*/
